import profileImage from '../assets/mylogo.png';
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 animate-in delay-100">
                        <div className="inline-block">
                            <span className="badge badge-primary">{t.hero.welcome}</span>
                        </div>
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight">
                            {t.hero.greeting} <span className="gradient-text">Heru nur cahyono</span>
                        </h1>
